...
using GestaoDeEquipamentosWeb.ConsoleApp.ModuloChamado.Apresentacao;
using GestaoDeEquipamentosWeb.ConsoleApp.ModuloChamado.Dominio;
using GestaoDeEquipamentosWeb.ConsoleApp.ModuloChamado.Infra;
using GestaoDeEquipamentosWeb.ConsoleApp.ModuloEquipamento.Dominio;
using GestaoDeEquipamentosWeb.ConsoleApp.ModuloEquipamento.Infra;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.Rendering;

namespace GestaoDeEquipamentosWeb.ConsoleApp.ModuloChamado.Apresentacao;
...
public class ChamadoController : Controller
{
    ...
    private readonly IChamadoLogger chamadoLogger;

    public ChamadoController(IChamadoLogger chamadoLogger)
    {
